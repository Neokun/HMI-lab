...
def plot_fully_rec(basic, Nbasic, label, my_limb = {}, save_mp4=False):
    ...
    new_plot(fully_rec, np.arange(0), 'result3/'+label, False, True, my_limb = my_limb, save_mp4=save_mp4)    
...
def my_mix_c():
    ...
    new_plot(sC, np.arange(0), 'result3/'+' M1 motion',fix_limb = True, my_limb = my_limb, save_mp4=True, pltshow = False)
    new_plot(sS, np.arange(0), 'result3/'+' M2 motion',fix_limb = True, my_limb = my_limb, save_mp4=True, pltshow = False)
    #new_plot(sT, np.arange(0), 'result3/'+' M3 motion',fix_limb = True, my_limb = my_limb, save_mp4=True, pltshow = False)

    #new_plot(compensate_translation(sC, Ctran), np.arange(0), 'result3/'+ 'Compensated M1 motion',fix_limb = True, my_limb = my_limb, save_mp4=True, pltshow = False)
    #new_plot(compensate_translation(sS, Stran), np.arange(0), 'result3/'+ 'Compensated M2 motion',fix_limb = True, my_limb = my_limb, save_mp4=True, pltshow = False)
    #new_plot(compensate_translation(sT, Ttran), np.arange(0), 'result3/'+ 'Compensated M3 motion',fix_limb = True, my_limb = my_limb, save_mp4=True, pltshow = False)
    ...
    for x in xrange(0, 10):
        ...
        new_plot(c_rec, cidxes,'result3/'+'M1: component '+  str(x) + 'th',fix_limb = True, my_limb = my_limb, save_mp4=True, pltshow = False)
    ...
    for y in xrange(0, 10):
        ...
        new_plot(rec , sidxes,'result3/'+'M2 component '+ str(y) +'th',fix_limb = True, my_limb = my_limb, save_mp4=True, pltshow = False)
    '''
    #YU_1 svd
    new_C = svd_yu_1(Cc, Cs, x,y, k)
    c_rec = np.tensordot(Wc, new_C, (1, 0)) + cmean[np.newaxis]
    new_plot(c_rec, cidxes,'result3/'+'DRYU 1: Combine '+ str(x) + 'th of M1 with ' +str(y) + 'th of M2',fix_limb = True, my_limb = my_limb, save_mp4=True, pltshow = False)
    '''
    ...
    for alphaaa in xrange(0,11):
        ...
        c_rec = np.tensordot(Wc, new_C, (1, 0)) + cmean[np.newaxis]
        new_plot(c_rec, cidxes,'result3/'+'DRYU 2: Combine '+ str(x) + 'th component of M1 M2 with alpha = ' +str(alpha),fix_limb = True, my_limb = my_limb, save_mp4=True, pltshow = False)
    ...
    new_plot(c_rec, tidxes,'result3/'+'DRYU 3: Retarget '+ str(x) + 'th component of M1 with ' +str(y) + 'th comp of M2 to M3',fix_limb = True, my_limb = my_limb, save_mp4=True, pltshow = False)
    '''
